...
--
-- Total execution time (ms) per query_type across the full requested date
-- range. Ranking/top-10+Other collapsing happens in the API route.

SELECT
  query_type,
  SUM(execution_time) AS metric_value
