...
--
-- Total bytes scanned per query_type across the full requested date range.
-- Ranking/top-10+Other collapsing happens in the API route.

SELECT
  query_type,
  SUM(bytes_scanned) AS metric_value
